...
Here is the code used in Lu et al. (J Neurosci, 2025), updated on 3/27/2026 - 6/4/2026. 
...
Major update: 6/4/2026, 6/10/2026. Fixed bugs in BWPOMMC in libPOMMC.c, and in POMM.py increased BWRerun to 200 for more optimal transition matrix P, 
    and fixed bugs in MinPOMMSimpDeleteStates. Reduced pValue to 0.01 to promote stability of the POMM from run to run. 
